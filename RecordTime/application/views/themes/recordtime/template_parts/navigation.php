  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav artist-menu-section">
            ...
            <?php if(isset($this->session->userdata['userid'])!= '' && $this->session->userdata['type'] == 1) {  ?>
                <li class="menu-items"><a href="<?php echo site_url(); ?>project/dashboard">Projects</a></li>
            <?php }elseif (isset($this->session->userdata['userid'])!= '' && $this->session->userdata['type'] == 2) { ?>
                <li class="menu-items"><a href="<?php echo site_url(); ?>project/producer_dashboard">Projects</a></li>
            <?php } ?>
      </ul>
      <ul class="nav navbar-nav navbar-right">
        <?php if(isset($this->session->userdata['userid'])!= '') {  ?>
            ...
            <?php }?>
                ...
                <?php }elseif ($this->session->userdata['type'] == 2) { ?>
                    <li><a href="<?= site_url('project/producer_dashboard')?>" class="txt-upper mobile-hide"><strong>My Projects</strong></a></li>
                <?php } ?>
