...
<!-- <div class="container"> -->
  ...
  <div class="row white-bg">
    ...
    <div class="create-profile-form col-md-4">
    	<div class="col-sm-12 signup-form">
            ...
            <form action="<?php echo base_url(); ?>artists/signup" method="post">
                ...
                <div class="form-group">
                  <input type="password" class="form-control" id="cnfp" placeholder="Confirm Password" name="cnfpassword">
                </div>
                <div class="form-group">
                ...
                <div class="col-sm-12 form-button-container">
                    <input type="submit" name="submit1" id="next" value="Sign up to record" class="orange signup-btn" style="padding: 0px;" /><span class="align-right" ><i class="fa fa-arrow-right"></i></span>
				    
                    <button type="submit" name="submit" id="submit" class="orange signup-btn" disabled="" style="padding: 0px; display: none;">Sign up to record</button>
                </div>
    ...
    <div class="col-sm-12 mt-50 text-right">
    	<div class="col-sm-8"></div>
        <div class="col-sm-4">
        <button class="orange signup-btn margin-bottom-minus-25" onclick="window.location.href='<?= site_url('artists/overview')?>'">Reasons to record <span class="align-right" ><i class="fa fa-arrow-right"></i></span></button>
        </div>
    </div>
   </div>
   <div class="row">
  ...
  <div class="row">
    ...
    <div class="col-sm-12 artist-producer-section overlay" style="background:url(<?= site_url().template_assets_path(); ?>/images/intrection1.png);padding:350px 0 0;">
    	<div class="col-sm-8">
...
<script>
    ...
    //             if (response == true) 
    //             {
    //                 $('#msg').html('<span style="color: red;">Email Id already exists.</span>');
    //             }else{
    //                 $('#msg').remove();
