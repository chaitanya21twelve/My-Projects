...
<?php //echo "<pre>"; print_r($projects); ?>
  <div class="ProjectsDashboard">
    <div class="ProjectList">
      <?php //echo "<pre>"; print_r($producerprojects); ?>
      <?php if (!empty($producerprojects)){ ?>
        <?php foreach ($producerprojects as $project){ ?>
              ...
              <div class="ProjectItem__Details row">
                ...
                <div class="col-sm-4">
                  ...
                  <div class="col-sm-4 pdf-change">
                    <button data-toggle="modal" data-target="#paymentModal" style="display: none;">Add Funds</button>
                    ...
                    <?php
                      if($project['status'] != 1){ 
                         ?>
                          ...
                          <?php if(!empty($project['firstname']) && !empty($project['lastname'])){ ?>
                    ...
                    <button data-toggle="modal" data-target="#markedModal">Mark as Complete</button>
