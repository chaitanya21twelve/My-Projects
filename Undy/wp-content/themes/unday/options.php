...
function optionsframework_options() {
	...
	$options[] = array(
		'name' => __('Basic Details', 'options_check'),
		'type' => 'heading');
	$options[] = array(
		'name' => __('Logo', 'options_check'),
		//'desc' => __('Upload Logo Here'),
		'id' => 'site_logo',
		'type' => 'upload');
	$options[] = array(
	...
	$options[] = array(
		'name' => __('Header Information', 'options_check'),
		'id' => 'header_info',
		'type' => 'editor',
	...
	$options[] = array(
		'name' => __('Company Details', 'options_check'),
		'type' => 'heading');
	...
	$options[] = array(
		...
		'type' => 'text');
	$options[] = array(
		'name' => __('Office Time', 'options_check'),
		//'desc' => __('A text input field.', 'options_check'),
		'id' => 'office_time',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('Footer Description', 'options_check'),
		//'desc' => __('A text input field.', 'options_check'),
		'id' => 'footer_desc',
		'std' => '',
		'type' => 'text');	
	$options[] = array(
		'name' => __('Footer Card Image', 'options_check'),
		//'desc' => __('Upload Logo Here'),
		'id' => 'fsite_image',
		'type' => 'upload');		
	$options[] = array(
		'name' => __('Copyrights', 'options_check'),
		//'desc' => __('A text input field.', 'options_check'),
	...
	$options[] = array(
		'name' => __('Social Details', 'options_check'),
		'type' => 'heading');
	$options[] = array(
