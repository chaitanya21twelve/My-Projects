 ...
 /**
   ...
   */ 
	public function __construct(){
	    ...
	    add_action( 'init', array($this,'addMembershipEndpoint'));
 		
		//add_filter( 'woocommerce_account_menu_items', array($this,'WineClubWcAccountMenuItems'));	
	 
		add_action( 'woocommerce_account_ret-medlemsskab_endpoint', array($this,'edit_medlemsskab_setting_endpoint_callback'));
   ...
   public function addMembershipEndpoint() {

	    add_rewrite_endpoint( 'ret-medlemsskab', EP_ROOT | EP_PAGES );
	...
	*/
    ...
    public function edit_medlemsskab_setting_endpoint_callback( ){
  	  ...
  	  //   $subscription->update_status( $post_status ); jQuery(".product-selector").find().show();
	    ...
	    if($subscriptions){
		    ...
		    <section class="product-selector" style="padding: 15px 0;">
		        	...
		        	<form action="" method="post" id="FormUpdate">
			        	...
			        	<div class="row selection-5">
				        	...
				        	<div class="Velkommen-text">
			                   ...
			                   <h2 class="text-center" style="font-weight: 800;">Dit Medlemskab</h2>
			                  
			                  
		 	                   <p class="text-center">Se og ret dit medlemskab her</p>
		 	                   <br>
					    ...
					    <div class="row selection-1" style="display:none;">
					    ...
					    <div class="row selection-3" style="display:none;">
 		 			    ...
 		 			    <div class="row selection-5" style="display:none">
