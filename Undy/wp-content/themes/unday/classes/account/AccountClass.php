	...
	*/
    ...
    public function subscription_box_setting_endpoint_callback( ){
	    ...
	    if($subscriptions){
					    ...
					    <div class="row selection-1" style="display:block;">
							...
							<div class="col-md-6">
					          ...
					          <div class="item-box <?php if(!empty($brief_cat)){ echo 'active'; } ?> cat-box-78"> 
							  	...
							  	<img src="<?php echo get_template_directory_uri().'/images/tick.png'; ?>" class="tick">

					            <h5 class="text-center">Boxerbriefs</h5>

					            <img src="<?php echo get_template_directory_uri().'/classes/product/assets/images/boxerbriefs_icon.png'; ?>" class="boxers">
							...
							<div class="col-md-6">
					          ...
					          <div class="item-box <?php if(!empty($shorts_cat)){ echo 'active'; } ?> cat-box-79"> 
					            ...
					            <img src="<?php echo get_template_directory_uri().'/classes/product/assets/images/boxershorts_icon.png'; ?>" class="boxers">
								<div style="display:none">
			...
			<section class="product-selector" style="display:none;">
