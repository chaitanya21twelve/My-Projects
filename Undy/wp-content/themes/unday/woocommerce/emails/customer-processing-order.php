...
<tr>
  ...
  <td align="center" valign="top" style="padding: 0 85px;" class="padding" >
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
      ...
      <tbody>
		...
		<tr>
          ...
          <td align="center" valign="top" style="font-family: 'Poppins',sans-serif;font-size: 14px;line-height: 20px;color: #000000;font-weight: normal;padding: 18px 0;"><?php printf( esc_html__( 'Vi bekræfter hermed, at vi har modtaget din ordre. Lige så snart vi har ekspederet din bestilling, sender vi dig en mail, hvor du har mulighed for at spore din pakke. Vi forventer, at du modtager din pakke inden for 1-2 dage.', 'woocommerce' ), esc_html( $order->get_order_number() ) ); ?></td>
