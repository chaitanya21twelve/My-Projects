  ...
  <td align="center" valign="top" style="padding: 0 85px;" class="padding" ><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
      ...
      <tbody>
		...
		<tr>
          ...
          <td align="center" valign="top" style="font-family: 'Poppins',sans-serif;font-size: 14px;line-height: 20px;color: #000000;font-weight: normal;padding: 18px 0;"><?php esc_html_e( 'Følgende note er føjet til din ordre:', 'woocommerce' ); ?><br /><br /><blockquote><?php echo wpautop( wptexturize( $customer_note ) ); ?></blockquote></td>
