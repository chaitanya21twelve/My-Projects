...
<!--	<p class="meta">-->
	<p>
		<span><?php comment_author(); ?></span> skrevet d. 
<!--		<strong class="woocommerce-review__author"><?php comment_author(); ?> </strong>-->
		...
		?>
		<span><time class="woocommerce-review__published-date" datetime="<?php echo esc_attr( get_comment_date( 'c' ) ); ?>"><?php echo esc_html( get_comment_date( wc_date_format('d.m.Y') ) ); ?></time></span>
