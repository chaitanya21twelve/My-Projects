...
woocommerce_login_form(
	array(
		'message'  => __( 'Hvis du har handlet hos os før, så log venligst ind nedenfor. Hvis du er ny kunde, så skal du blot indtaste dine oplysninger under "Kunde oplysninger".', 'woocommerce' ),
