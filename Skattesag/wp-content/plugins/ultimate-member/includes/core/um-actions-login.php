...
function um_submit_form_errors_hook_login( $args ) {
	...
	if ( isset( $args['username'] ) && $args['username'] == '' ) {
		...
		UM()->form()->add_error( 'username',  __('Indtast venligst dit brugernavn eller e-mail','ultimate-member') );
	...
	if ( $args['user_password'] == '' ) {
		...
		UM()->form()->add_error( 'user_password',  __('Indtast venligst dit kodeord','ultimate-member') );
	...
	if ( $user && wp_check_password( $args['user_password'], $user->data->user_pass, $user->ID) ) {
		...
		UM()->form()->add_error( 'user_password',  __('Adgangskoden er forkert. Prøv igen.','ultimate-member') );
...
function um_add_submit_button_to_login( $args ) {
	...
	<div class="um-col-alt">
		...
		<?php if ( isset( $args['show_rememberme'] ) && $args['show_rememberme'] ) {
			...
			UM()->fields()->checkbox( 'rememberme', __( 'Forbliv logget ind', 'ultimate-member' ), false ); 
