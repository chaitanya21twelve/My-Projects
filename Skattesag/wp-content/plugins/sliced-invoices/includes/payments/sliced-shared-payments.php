	...
	public function create_payment_button_inline( $gateway, $readable ) {
		...
		<div class="sliced_gateway_button">
			...
			<form method="POST" action="<?php echo esc_url( get_permalink( (int)$payments['payment_page'] ) ) ?>">
				...
				<input type="submit" name="start-payment" class="gateway btn btn-success btn-sm" value="Betal online her">

				<?php /*<input type="submit" name="start-payment" class="gateway btn btn-success btn-sm" value="<?php
