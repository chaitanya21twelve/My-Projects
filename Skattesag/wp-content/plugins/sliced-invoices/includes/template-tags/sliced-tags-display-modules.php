...
if ( ! function_exists( 'sliced_display_from_address' ) ) :
	...
	function sliced_display_from_address() { ?>
			...
			<div class="from"><strong><?php _e( 'Fra:', 'sliced-invoices' ) ?></strong></div>
...
if ( ! function_exists( 'sliced_display_to_address' ) ) :
	...
	function sliced_display_to_address() {
		...
		$output = '<div class="to"><strong>' . __( 'Til:', 'sliced-invoices' ) . '</strong></div>';
			...
			<table class="table table-bordered table-sm">
				...
				<?php if( sliced_get_invoice_number() ) : ?>
					...
					<tr>
						...
						<td><?php printf( esc_html_x( '%s nummer', 'invoice number', 'sliced-invoices' ), sliced_get_invoice_label() ); ?></td>
				...
				<?php if( sliced_get_invoice_created() ) : ?>
					...
					<tr>
						...
						<td><?php printf( esc_html_x( '%s dato', 'invoice date', 'sliced-invoices' ), sliced_get_invoice_label() ); ?></td>
				...
				<?php if( sliced_get_invoice_due() ) : ?>
					...
					<tr>
						...
						<td><?php _e( 'Forfaldsdato', 'sliced-invoices' ) ?></td>
				...
				*/
				...
				if ( $totals['payments'] ) {
					...
					<tr class="row-paid">
						...
						<td class="rate"><?php _e( 'Betalt', 'sliced-invoices' ) ?></td>
