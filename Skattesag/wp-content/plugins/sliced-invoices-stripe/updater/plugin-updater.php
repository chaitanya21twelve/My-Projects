 ...
 * Calls the class.
 */
function sliced_call_stripe_gateway_updater_class() {
    return Sliced_Stripe_Gateway_Updater::get_instance();
}
add_action('sliced_loaded', 'sliced_call_stripe_gateway_updater_class', 1);    


class Sliced_Stripe_Gateway_Updater {

	private $store_url   = 'http://slicedinvoices.com';
	private $name        = 'Stripe Payment Gateway';
	private $download_id = '2458';
	private $version     = SI_STRIPE_VERSION;
	private $slug        = 'stripe_gateway';
	private $text_domain = 'sliced-invoices-stripe';

	private $key_name    = 'stripe_gateway_license_key';
	private $status_name = 'stripe_gateway_license_status';
	private $error_name  = 'stripe_gateway_license_error';
	...
	public function plugin_updater() {
		// setup the updater
		new Sliced_Plugin_Updater( $this->store_url, SI_STRIPE_FILE, array(
