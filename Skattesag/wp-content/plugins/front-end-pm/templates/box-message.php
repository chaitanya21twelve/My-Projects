...
if( ! fep_get_user_message_count( 'total' ) ) {
	echo '<div class="fep-error">' . apply_filters( 'fep_filter_messagebox_empty', esc_html__( 'Velkommen til din kundeportal. Her kan du løbende følge med i din sag, uploade relevante dokumenter der automatisk bliver krypteret, og meget mere.', 'front-end-pm' ), $action ) . '</div>';
	return;
}
