...
class Fep_Form {
	...
	public function form_fields( $where = 'newmessage' ){
		...
		$fields = array(
			'message_to' => array(
				'label'					=> __( 'Modtager', 'front-end-pm' ),
	...
	public function form_field_output( $where = 'newmessage', $errors= '', $value = array() ){
		...
		if( 'settings' == $where ) {
			...
			$button_val = __( 'svar', 'front-end-pm' );
		} else {
			$button_val = __( 'Send besked', 'front-end-pm' );
		}
