...
<style type="text/css">
	...
	box-shadow: 0px 1px 17px -6px rgba(0, 0, 0, 0.3);
	background-color: #fff;
	padding: 40px;
}
	.wpfm_upload_files_wrapper .wpfm_upload_button {
...
<div class="wpfm-wrapper">
	...
	<div class="wpfm-body-area">
		...
		<div class="wpfm_upload_files_wrapper">
			...
			<div class="col-sm-12 text-center wpfm_upload_button" id="upload_files_btn_area">
				...
				<h3 style="color: #acacac;">Drop dine filer her</h3><br>
				<p style="color: #acacac;">eller</p><br>
	...
	#wpfm_file_loading_wrapper .text-center{
		margin: 0 auto;
	}
	</style>
