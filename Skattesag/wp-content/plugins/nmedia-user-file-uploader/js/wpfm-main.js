jQuery(function($){
	...
	*/
	...
	/* files drag into dir */
	// function dropSuccessHandler($event, index, file){
 ...
 //    	// $http.post(nm_filemanager_vars.ajaxurl, data ).then(function(resp){   
 ...
 //    function onDrop($event,$data,file){
 ...
 //    }
    ...
    // $('.wpfm-img').on('drag',function($event){
